...
@section('content')
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="text-center px-6 py-4 text-sm text-gray-500">Belum ada produk terjual bulan ini.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden mb-6">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <!-- Tabel Kasir Paling Aktif Bulan Ini -->
                <thead class="bg-gray-50">
                    <tr>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-800">Supplier Terlibat Bulan Ini</h2>
        </div>
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <!-- Tabel Supplier Terlibat Bulan Ini -->
                <thead class="bg-gray-50">
                    <tr>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($suppliersInvolvedMonthly as $supplier)
                        <tr>
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="text-center px-6 py-4 text-sm text-gray-500">Belum ada supplier yang produknya terjual bulan ini.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
